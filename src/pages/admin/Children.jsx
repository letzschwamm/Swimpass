        ...
        {filtered.length === 0
          ? (
            <div style={{ padding: 40, textAlign: 'center', color: 'var(--muted)', fontSize: 13 }}>
              <div style={{ marginBottom: 12 }}><img src="/swimpass_icon_final.png" alt="" style={{ width: 48, height: 48, objectFit: 'contain', opacity: 0.4, borderRadius: 12, background: 'transparent' }} /></div>
              {ui.noChildren}
            </div>
          ) : (
            <table>
